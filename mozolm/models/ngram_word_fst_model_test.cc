...
TEST_F(PpmAsFstTest, ContextStateImplicit) {
  NGramWordFstModel model;
  ASSERT_OK(model.Read(storage_));
...
TEST_F(PpmAsFstTest, ContextStateImplicitSame) {
  NGramWordFstModel model;
  ASSERT_OK(model.Read(storage_));
...
TEST_F(PpmAsFstTest, ExtractLMScoresStart) {
  NGramWordFstModel model;
  ASSERT_OK(model.Read(storage_));
...
// continuation.
TEST_F(PpmAsFstTest, ExtractLMScoresImplicitOneContinuation) {
  NGramWordFstModel model;
  ASSERT_OK(model.Read(storage_));
...
TEST_F(PpmAsFstTest, ExtractLMScoresImplicitWordBoundary) {
  NGramWordFstModel model;
  ASSERT_OK(model.Read(storage_));
